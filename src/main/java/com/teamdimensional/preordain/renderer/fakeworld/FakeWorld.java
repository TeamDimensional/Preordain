...
public class FakeWorld extends World {
    // Copied from Multiblocked's code, licensed under LGPL
    // https://github.com/CleanroomMC/Multiblocked/blob/master/src/main/java/com/cleanroommc/multiblocked/util/world/DummyWorld.java

    private static final WorldSettings DEFAULT_SETTINGS = new WorldSettings(1L, GameType.SURVIVAL, true, false, WorldType.DEFAULT);

    public FakeWorld() {
        super(new FakeSaveHandler(), new WorldInfo(DEFAULT_SETTINGS, "FakeWorld"), new WorldProviderSurface(), new Profiler(), false);
        // Guarantee the dimension ID was not reset by the provider
        this.provider.setDimension(Integer.MAX_VALUE - 1001);
